...
ウインドウ右側のディレクトリサイドバーには、開いているPDFの親フォルダ以下がツリー表示されます。PDFをクリックすると開き、フォルダの三角マークで展開・折りたたみができます。サイドバー右上のフォルダアイコンは「表示するフォルダを選び直す」ボタンで、新規フォルダの作成はできません。矢印キーでツリー内を移動し、`Return` キーで選択中のPDFを開けます。
